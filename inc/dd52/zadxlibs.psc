...
function onregisterdevices(string eventname, string strarg, float numarg, form sender)
endfunction
function manipulatedevice(actor akactor, armor device, bool equiporunequip, bool skipevents)
endfunction
